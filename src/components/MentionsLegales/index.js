...
const MentionsLegales = () => (
  <div className="mentionsLegales">
    ...
    <p>
      ...
      Contact : claudiavacant@live.fr 0557898372
      Adresse : chemin du dev
      33000 BORDEAUX.
    </p>
    <p>
      Identification de l'entreprise : Claudia,Fouzia,Jonathan
      Mathieu
      Paul au capital social de € - SIREN : - RCS ou RM : - Adresse postale : chemin du dev
      33000 BORDEAUX.
    </p>
    <p>
      Hébergeur : Autresurge https://surge.sh/
    ...
    <p>
      ...
      relatives à la navigation d’un utilisateur sur un site. Les données ainsi obtenues
    ...
    <p>
      ...
      paramètres de votre navigateur. Aucun cookie ne sera déposé sans votre consentement.
    </p>
    <p>
    ...
    <p>
      En dehors des cas où la loi ne le permet pas,
      il est fait attribution exclusive de juridiction aux tribunaux compétents de British Columbia, Canada.
    </p>
  </div>
